...
antechamber -i ${inmol2} -fi mol2 -o LIG-1.mol2 -fo mol2 -c bcc -nc 0 -pf y
...
sed -i 's/HSD/HIS/g' ${inpdb}
sed -i 's/HSE/HIS/g' ${inpdb}

echo 1|gmx pdb2gmx -f ${inpdb} -o build.gro -water tip3p -ignh
